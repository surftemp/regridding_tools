        ...
        if climatology:
            if d.month == 2 and d.day == 29:
                ...
                filename = (os.path.join(self.sst_climatology_path,
                                         'D059-ESACCI-L4_GHRSST-SSTdepth-Climatology-GLOB_CDR3.0-v02.0-fv01.0.nc'),
                            os.path.join(self.sst_climatology_path,
                                         'D060-ESACCI-L4_GHRSST-SSTdepth-Climatology-GLOB_CDR3.0-v02.0-fv01.0.nc'))
            else:
                ...
                filename = (os.path.join(self.sst_climatology_path, 'D' + str(day_of_year).zfill(3) +
                                         '-ESACCI-L4_GHRSST-SSTdepth-Climatology-GLOB_CDR3.0-v02.0-fv01.0.nc'))
